...
public class SecurityLogging extends SQLiteOpenHelper {
	...
	public SecurityLogging(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_EVENT_TABLE = "CREATE TABLE " + TABLE_EVENTS + "("
				...
				+ KEY_URL + " STRING NOT NULL," + KEY_TYPE + " INTEGER NOT NULL" + ")";
	...
	public void addEvent(SecurityEvent data) {
		SQLiteDatabase db = this.getWritableDatabase();
	...
	public List<SecurityEvent> getAllEntries() {
		List<SecurityEvent> dataList = new ArrayList<SecurityEvent>();
		// Select All Query
		...
		if (cursor.moveToFirst()) {
			do {
				SecurityEvent data = new SecurityEvent();
				...
				data.type = Integer.parseInt(cursor.getString(4));
				// Adding data to list
				dataList.add(data);
	...
	// Getting All Contacts
		public List<SecurityEvent> getEntries(Date start, Date end) {
	...
	public void writeDataLine(SecurityEvent values){
	...
	public List<SecurityEvent> getEntriesBatch(long id) {
		List<SecurityEvent> dataList = new ArrayList<SecurityEvent>();
		// Select All Query
		String selectQuery = "SELECT * FROM " + TABLE_EVENTS;
