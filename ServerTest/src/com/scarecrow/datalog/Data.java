...
public class Data {
	...
	public Data(int ident, long timeVal, double temp, double humid, byte light, byte soilSensor1, byte lightSensor1, double nodeTemp1, byte soilSensor2, byte lightSensor2, double nodeTemp2) {
		id = ident;
		time = timeVal;
